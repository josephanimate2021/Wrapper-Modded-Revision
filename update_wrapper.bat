...
git pull || echo Updating Wrapper Has Failed! Attempting To Reset On Whatever went wrong. && git stash && git pull || echo Reseting The Updater has failed! Please enter the commands listed above to resolve this issue. && call cmd.exe
cls
